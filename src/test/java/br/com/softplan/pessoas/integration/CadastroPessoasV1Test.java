...
public class CadastroPessoasV1Test {
	@LocalServerPort
	private int port;
	...
	private String jsonBeltranoCorreto = ResourceUtils.getContentFromResource(
			"/payloads/pessoas/v1/correto/beltrano-post-payload.json");

	private String jsonFulanoPutCorreto = ResourceUtils.getContentFromResource(
			"/payloads/pessoas/v1/correto/fulano-put-payload.json");

	private String jsonPessoaSemNome = ResourceUtils.getContentFromResource(
			"/payloads/pessoas/v1/incorreto/pessoa-sem-nome-payload.json"
	);

	private String jsonPessoaCpfRepetido = ResourceUtils.getContentFromResource(
			"/payloads/pessoas/v1/incorreto/pessoa-cpf-repetido-payload.json"
	);

	private String jsonPessoaEmailInvalido = ResourceUtils.getContentFromResource(
			"/payloads/pessoas/v1/incorreto/pessoa-email-invalido-payload.json"
	);
	...
	public void setUp() {
		...
		RestAssured.basePath = "/v1/pessoas";
